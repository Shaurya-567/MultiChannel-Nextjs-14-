...
const Home = () => {
  return (
    <>
      <section className=' md:items-center overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center'>
        ...
        md:mt-[-90px] 
        sm:w-full 
        w-[750px] flex justify-center items-center mt-[-40px] relative sm:ml-0 ml-[-50px] '>
